...
class MainGameWindow(tk.Tk):
    def __init__(self, *args, **kwargs):
        ...
        self.geometry(Cons.CONFIG_FILE['game_geometry'])
        self.title(Cons.CONFIG_FILE['game_name_short'] + Cons.CONFIG_FILE['game_name'])
        ...
        if Cons.USER_FILE['quest'] == Cons.CONFIG_FILE['starting_quest']:
